...
% TODO: add all acronyms
\AddAcronym{AI}{Artificial Intelligence}
\AddAcronym{CPU}{Central Processing Unit}
\AddAcronym{GIL}{Global Interpreter Lock}
\AddAcronym{GPU}{Graphics Processing Unit}
\AddAcronym{I/O}{Input/Output}
\AddAcronym{HLFET}{Highest Level First with Estimated Times}
\AddAcronym{HPC}{High-performance Computing}
\AddAcronym{MSD}{Minimal Scheduling Delay}
\AddAcronym{MPI}{Message Passing Interface}
\AddAcronym{JSON}{JavaScript Object Notation}
\AddAcronym{NUMA}{Non-uniform Memory Access}
\AddAcronym{OpenMP}{Open Multi-processing}
\AddAcronym{PGAS}{Partitioned Global Address Space}
\AddAcronym{PRNG}{Pseudo-random Number Generation}
