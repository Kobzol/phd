...
state in a database, which enabls users to observe the history of executed workflows. It also
...
\subsection*{\dask}
\dask~\cite{dask} was extensively decribed in~\Autoref{sec:rsds-dask}. It is a
...
workflows, \hyperqueue{} easily outperforms it, which is further validated
...
resource requirements. In terms of scheduling, it implements several simple
scheduling algorithms; users can select which one should be used. Assignment of tasks to allocations is performed in a
