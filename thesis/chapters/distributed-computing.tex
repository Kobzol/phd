...
The goal of this chapter is thus to provide a broad overview of the most popular approaches for
implementing distributed and parallel applications (with particular focus on \gls{hpc}
use-cases), and also to gradually concretize which niches of this diverse area are most relevant
...
different set of challenges and constraints in comparison to coarse-grained scientific workflows,
and they are not primarily designed for such use-cases. Therefore, they are not the primary focus
of this thesis.
...
parallel and implicitly parallel models, and showed several examples of both approaches.

It has also specified the subset of distributed computing that is important for this thesis. In
...
The following chapter will define a vocabulary of terms relevant to such task-based programming
models, and~\Autoref{ch:sota} will then describe challenges faced by existing
state-of-the-art distributed task runtimes that leverage these programming models in
