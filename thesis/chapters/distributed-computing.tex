...
and parallel applications, with the focus on \gls{hpc} use-cases. It describes various
programming models and selected state-of-the-art tools that leverage them. It categorizes these
...
relevant to task-based programming models, and~\Autoref{ch:sota} will then describe
challenges faced by existing state-of-the-art batch processing distribtued task runtimes in
