The previous chapter has described various approaches that can be used to implement distributed
...
in~\Autoref{ch:challenges}. The definitions will be general enough so that they can be applied to
concepts used by task execution tools described in the previous chapters, and also additional tools
...
transferring data between them. This definition is general enough so that it can be applied to task
execution tools mentioned in this thesis.
...
task-based programming model. Several of them were already described in~\Autoref{ch:distributed-computing}.
\Autoref{ch:rsds} will depict the architecture of \dask{}, a state-of-the-art
