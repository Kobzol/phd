Even though the previous chapter has specified a very precise subset of task-based programming
...
in~\Autoref{ch:sota}. The definitions are general enough so that they can be applied to
