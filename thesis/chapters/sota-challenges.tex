...
After the general overview of existing task runtimes presented in this
chapter,~\Autoref{ch:rsds} will provide a detailed analysis of \dask{}, a
state-of-the-art task runtime, and~\Autoref{hq:related-work} will then compare several existing task
runtimes with \hyperqueue{}, which will be the main topic of~\Autoref{ch:hyperqueue}.
