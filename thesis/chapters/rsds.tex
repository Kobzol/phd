...
the \texttt{pandas}\footnoteurl{https://pandas.pydata.org} interface for table processing and
...
\dask{} manual\footnoteurl{https://distributed.dask.org/en/latest/work-stealing.html}.
...
Figure~\ref{fig:dask-gil-scaling} demonstrates the effect of GIL on the
...
All these experiments have shown that \rsds{} exhibits similar performance behavior and scaling
...
central server\footnoteurl{https://github.com/it4innovations/rsds}. It was built from the ground up with a focus on runtime
