...
\section*{Publications Related to Thesis}
	\begin{itemize}
		...
		\item\fullcite{rsds}\par{}Total citations: 8 (2 self-citations), venue: conference proceedings
...
\section*{Publications Not Related to Thesis}
	\begin{itemize}
		\item\fullcite{sisa}\par{}Total citations: 45 (20 self-citations), venue: conference proceedings
		...
		\item\fullcite{spin2}\par{}Total citations: 21 (5 self-citations), venue: conference proceedings
		\item\fullcite{smi}\par{}Total citations: 27 (2 self-citations), venue: conference proceedings
