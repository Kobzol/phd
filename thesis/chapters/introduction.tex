...
heterogeneous supercomputers, this thesis sets out the following objectives:
...
\begin{itemize}
	...
	\item Describe a set of guidelines for overcoming these challenges and enabling effortless execution of
	      task graphs on modern heterogeneous clusters, which should be usable as a guidance for implementing
