...
\begin{tablenotes}
	...
	\item \textsuperscript{\dag}with an external plugin; \textsuperscript{*}output goes through
	files
\end{tablenotes}
...
%TODO: move generic workers to meta-scheduling part?
...
% autoalloc: yes (https://snakemake.github.io/snakemake-plugin-catalog/plugins/executor/slurm.html)
% deps: filesystem
% data transfer between tasks: no
...
- useful for ML
- tasks are low level
- has autoscaling, but not for Slurm
...
% meta-scheduling: manual (https://autosubmit.readthedocs.io/en/master/userguide/wrappers/index.html)
% autoalloc: yes
% deps: explicit
% data transfer between tasks: no
% stdout/stderr streaming: no
