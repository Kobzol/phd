...
%    \newcolumntype{C}[1]{>{\centering\arraybackslash}p{#1}}
	...
	\centering \rot{Graph partitioning} &
...
%	\midrule
	\snakemake{}\hfill\cite{snakemake} & \no & \yes & \yes & \no & \yes & \manualmap & \yes\textsuperscript{\dag} & \yes & \yes & \no & \yes & ? & \no & \no & \python \\[2mm]
%	\midrule
	\hyperqueue{}\hfill\cite{hyperqueue} & \yes & \yes & \yes & \yes & \no & \automaticmap & \yes & \yes & \yes & \yes & \yes & \yes & \no & \yes & \\
	\bottomrule
\end{tabular}
\begin{tablenotes}
	\centering
