...
\vspace{2mm}\makedef{def:task_graph_execution_ident} A \emph{task graph execution with support for
...
\vspace{1mm}Informally, at any given point in time, if a task is being executed on a worker, at
