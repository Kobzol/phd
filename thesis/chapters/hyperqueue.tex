...
\gls{hpc} clusters. Some of these were related to performance aspects caused by the
unique scale of
\gls{hpc} use-cases. The previous two chapters focused on these aspects, by examining
...
complex resource requirements and many others.

This thesis focuses primarily on ergonomical challenges that might cause a barrier for executing
task graphs on \gls{hpc} clusters using off-the-shelf task runtimes.
