...
Fractional resources are not supported by most task runtimes, although they are present in
...
To our knowledge, there are no existing task runtimes that support all the described advanced
resource management concepts, which could improve the flexibility of task graph execution on
heterogeneous clusters.
