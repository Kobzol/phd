...
%    \newcolumntype{C}[1]{>{\centering\arraybackslash}p{#1}}
	...
	\textsc{HyperShell}~\cite{hypershell}\\
	\dask{}~\cite{dask} & C & \no & \no & \no & \no & \no & \no & \no\textsuperscript{\dag{}} & \no & \no & \no & \no & \no & \no & \no & \no & Python \\
	\ray{}~\cite{ray} & C & \no & \no & \no & \no & \no & \no & \no\textsuperscript{\dag{}} & \no & \no & \no & \no & \no & \no & \no & \no & Python \\
	\textsc{Parsl}~\cite{parsl} & C & \no & \no & \no & \no & \no & \no & \no\textsuperscript{\dag{}} & \no & \no & \no & \no & \no & \no & \no & \no & Python \\
	\textsc{PyCOMPSs}~\cite{pycompss} & C & \no & \no & \no & \no & \no & \no & \no\textsuperscript{\dag{}} & \no & \no & \no & \no & \no & \no & \no & \no & Python \\
	\textsc{Pegasus}~\cite{pegasus} & C & \no & \no & \no & \no & \no & \no & \no\textsuperscript{\dag{}} & \no & \no & \no & \no & \no & \no & \no & \no & Python \\
	\textsc{Balsam}~\cite{balsam} & C & \no & \no & \no & \no & \no & \no & \no\textsuperscript{\dag{}} & \no & \no & \no & \no & \no & \no & \no & \no & Python \\
	\textsc{AutoSubmit}~\cite{autosubmit} & C & \no & \no & \no & \no & \no & \no & \no\textsuperscript{\dag{}} & \no & \no & \no & \no & \no & \no & \no & \no & Python \\
	\textsc{FireWorks}~\cite{fireworks} & C & \no & \no & \no & \no & \no & \no & \no\textsuperscript{\dag{}} & \no & \no & \no & \no & \no & \no & \no & \no & Python \\
	\textsc{Merlin}~\cite{merlin} & C & \no & \no & \no & \no & \no & \no & \no\textsuperscript{\dag{}} & \no & \no & \no & \no & \no & \no & \no & \no & Python \\
