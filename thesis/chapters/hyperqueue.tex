%TODO: worker constraint usage + HQ usage
%TODO: objectives
%TODO: Ligen virtual screening diagram
...
and a \emph{worker resource variant constraint} in the context of an execution $E^{var} = (G^{var}, C, \fntaskworkerassigned, \fntaskvarassigned)$, where $G^{var} = (\settasks, \setobjects, \setarcs, \setresourcekinds, \fntaskresvar)$ is
