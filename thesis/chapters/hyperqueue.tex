...
and a \emph{worker resource constraint with resource variants} in the context of an execution $E^{var} = (G^{var}, C, \fntaskworkerassigned, \fntaskvarassigned)$, where $G^{var} = (\settasks, \setobjects, \setarcs, \setresourcekinds, \fntaskresvar)$ is
