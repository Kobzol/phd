...
definitions might thus deviate from terminology used in previous theoretical works.
\todo{Differences will be highlighted where needed.}
...
captures the basic structure of dependencies between tasks, to provide basic intuition.\todo{Later
we will add more complex task graph definitions, as needed.}
